...
> {
    ...
    private lateinit var dependenciesProvider: DependenciesProvider<BASE_DEPENDENCIES>
    private var component: BASE_API? = null

    fun init(dependenciesProvider: DependenciesProvider<BASE_DEPENDENCIES>) {
    ...
    fun get(): BASE_API {
        ...
        return component ?: synchronized(this) {
            component ?: buildComponent(dependenciesProvider()).also {
                component = it
            }
        }
    }
